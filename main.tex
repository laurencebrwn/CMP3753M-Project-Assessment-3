...
\input{chapters/appendices/appendix-alexnet.tex}
\chapter{DenseNet201 Design and Results}
\input{chapters/appendices/appendix-densenet.tex}
\chapter{ResNet50V2 Design and Results}
\input{chapters/appendices/appendix-resnet.tex}
\chapter{SqueezeNet Design and Results}
\input{chapters/appendices/appendix-squeezenet.tex}
\chapter{Xception Design and Results}
\input{chapters/appendices/appendix-xception.tex}
\chapter{ConvNet Design and Results}
\input{chapters/appendices/appendix-convnet.tex}
\chapter{Xception Improvements Design and Results}
\input{chapters/appendices/appendix-xception-improvements.tex}
\chapter{Xception Final Design and Results}
\input{chapters/appendices/appendix-xception-final.tex}
\end{document}
