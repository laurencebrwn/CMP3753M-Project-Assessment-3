...
In this project, TensorBoard 2.8.0 was used and is a hard requirement to run the artifact. As with TensorFlow, it is recommended to use TensorBoard 2.0 or later, but with some code modifications, TensorBoard 1.0+ can also be used.

\subsubsection{Scikit-Learn}
Scikit-Learn is a machine learning library built for Python, which is bundled with many evaluation functions \citep{33Metric9:online}.
...
Google Cloud Platform and its subsidiary solutions are not a requirement to run the artifact.
