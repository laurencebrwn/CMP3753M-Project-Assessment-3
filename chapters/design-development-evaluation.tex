...
\section{Results}
The following are the results from the initial round of training, showing only the best hyper-parameter variations. The full results can be seen in the appendices.

\begin{table}[H]
    \caption{Risks likely to be encountered during this project.}
    \centering
    \begin{tabular}{l|l|l|l|l|l}
    \begin{tabular}[c]{@{}l@{}}Model and\\ Hyper-Parameters\end{tabular} & Accuracy & Precision & Recall & F1 Score & \begin{tabular}[c]{@{}l@{}}Training\\ Time (s)\end{tabular} \\
    \hline\hline
    \begin{tabular}[c]{@{}l@{}}\textbf{Xception}\\ Dense units - 128\\ Dropout - 0.1\\ Optimiser - Adam\\  Learning rate - 0.001\end{tabular} & 0.9780 & 0.9919 & 0.9640 & 0.9775 & 1202 \\
    \begin{tabular}[c]{@{}l@{}}\textbf{DenseNet}\\ Dense units - 128\\ Dropout - 0.1\\ Optimiser - Adam\\ Learning rate - 0.0005\end{tabular} & 0.9745 & 0.9900 & 0.9590 & 0.9738 & 762 \\
    \begin{tabular}[c]{@{}l@{}}\textbf{ResNet}\\ Dense units - 64\\ Dropout - 0.2\\ Optimiser - Adam\\ Learning rate - 0.0005\end{tabular} & 0.9510 & 0.9771 & 0.9240 & 0.9488 & 557 \\
    \begin{tabular}[c]{@{}l@{}}\textbf{SqueezeNet}\\ Dropout - 0.2\\ Optimiser - Adam\\ Learning rate - 0.0005\end{tabular} & 0.9290 & 0.9036 & 0.9620 & 0.9316 & 282 \\
    \begin{tabular}[c]{@{}l@{}}\textbf{ConvNet}\\ Dense units - 128\\ Dropout - 0.2\\ Optimiser - RMS-Prop\\ Learning rate - 0.0005\end{tabular} & 0.7995 & 0.7823 & 0.8340 & 0.8060 & 331 \\
    \begin{tabular}[c]{@{}l@{}}\textbf{AlexNet}\\ Dense units - 1024\\ Dropout - 0.2\\ Optimiser - SGD\\ Learning rate - 0.001\end{tabular} & 0.7095 & 0.8123 & 0.5480 & 0.6532 & 734
\end{tabular}
\end{table}
